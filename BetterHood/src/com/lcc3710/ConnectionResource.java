	...
	public void onCreate(Bundle savedInstanceState) {
		...
		switch (requestCode) {
			...
			case BetterHood.REQ_SIMILAR_SCREEN_INTEREST:
				queryBase = BetterHood.PHP_FILE_POPULATE_SIMILAR_INTEREST_LIST;
				break;
			case BetterHood.REQ_SIMILAR_SCREEN_EVENTS_HAVE:
				queryBase = BetterHood.PHP_FILE_POPULATE_SIMILAR_EVENTS_HAVE;
				break;
			...
			case BetterHood.REQ_COMMENT_POST: 
				queryBase = BetterHood.PHP_FILE_POST_EVENT_COMMENT;
				break;
			case BetterHood.REQ_COMMENT_POPULATE: 
				queryBase = BetterHood.PHP_FILE_POPULATE_EVENT_COMMENT;
				break;
			default:
